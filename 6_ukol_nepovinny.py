...
regular_string_3 = re.compile(r"((\"?[A-Za-z0-9_]+\+*\-?\.?[A-Za-z0-9_]+\"?@[A-Za-z0-9]+\-?[A-Za-z0-9]*[.][A-Za-z0-9]*[[com,net,museum,name,jp,co,cz]{1}\.?[net,museum,name,com,jp,co,cz]?)|([a-z]+@\[?(\d{3}\.+)+\d{3}]?))")
